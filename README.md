...
A few details are still being finalized and are shown as **“TBD”** on the site: the exact workshop day
(Dec 11 or 12) and sponsors. See `OUTPUT.md` for the full list.
